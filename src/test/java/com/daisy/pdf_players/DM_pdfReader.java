...
public class DM_pdfReader {
	...
	public void saveJsonToFile_workingGood(JSONObject jsonData) {
	...
	public void saveJsonToFile(JSONObject jsonData, String customPath) {
	    // Ensure the custom path is not empty
	    if (customPath == null || customPath.isEmpty()) {
	        System.err.println("Custom path is empty. File not written.");
	        return;
	    }

	    // Create a filename using the current timestamp
	    String timestamp = String.valueOf(System.currentTimeMillis());
	    String fileName = "Daisy_Generated_Data_" + timestamp + ".json"; // Create filename

	    // Create a File object for the output file
	    File outputFile = new File(customPath, fileName);
	    ...
	    try (FileWriter fileWriter = new FileWriter(outputFile)) {
	        fileWriter.write(jsonData.toString(4)); // Write JSON data with pretty-print
	        System.out.println("JSON File has been stored at location: " + outputFile.getAbsolutePath());
	    } catch (IOException e) {
	        System.err.println("An error occurred while saving the JSON file: " + e.getMessage());
	    }
	}
	...
	public void writeJsonToFile(JSONObject jsonData, String defaultFilePath, String customPath) {
		...
		String pathToUse = (customPath == null || customPath.isEmpty() || customPath.isBlank()) ? defaultFilePath
				: customPath;
...
//	        System.out.println("File will be generated at " + fileName);
		fileName = "D:\\Coding\\Ecllipse\\Ecllipse Projects\\PDF_Players\\Test PDF's\\fsData.pdf";
		customPath= "D:\\Coding\\Ecllipse\\Ecllipse Projects\\PDF_Players\\Generated File";
		/*
		 * defaultGeneratedFilepath =
		 * "D:\\Coding\\Ecllipse\\Ecllipse Projects\\PDF_Players\\Generated File";
		 * 
		 * createdFile =
		 * "D:\\Coding\\Ecllipse\\Ecllipse Projects\\PDF_Players\\Generated File";
		 */
		...
		ob.saveJsonToFile(jsonData,customPath);
//	        ob.writeJsonToFile(jsonData, defaultGeneratedFilepath,createdFile);
		...
		System.out.println("Total Time take to Read and give output is " + hours + " hours: " + minutes + " minutes: "
				+ seconds + " seconds");
